      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm" style={{ color: 'rgba(255,253,208,0.6)', lineHeight: '1.7' }}>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="space-y-3">
              <p className="text-sm" style={{ color: 'rgba(255,253,208,0.7)' }}>
                Bettampady, Puttur Taluk
              </p>
              <a
                href="tel:9740449324"
                className="block text-sm font-semibold transition-colors duration-200 hover:underline"
                style={{ color: '#D4AF37' }}
              >
                +91 97404 49324
              </a>
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold tracking-wider uppercase transition-all duration-300 hover:scale-105 mt-2"
                style={{
